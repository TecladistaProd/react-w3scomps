...
class Modal extends PureComponent<Props, State> { 
  ...
  render() {
    // @ts-ignore
    if(!this.props.onClose || this.props.modalOpened === 'undefined' ||typeof this.props.onClose !== 'function'){
      throw new Error('You should pass onClose and modalOpened state')
    }
    return(
      <div className={this.props.modalOpened ? 'active': ''} css={styles}>
        <div className="modal-content">
          <button className="close" onClick={this.props.onClose}><span>&times;</span></button>
