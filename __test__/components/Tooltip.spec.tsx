...
describe('Tooltip Component', () => {
  ...
  it('should render normaly', () => {
    const { container } = rtlRender(
      <Tooltip tooltipText="World" text="Hello"></Tooltip>,
    );

    expect(container.querySelector('div span.tooltiptext')?.textContent).toBe(
      'World',
    );
  });
  ...
  it('should dispatch an error', () => {
    ...
    expect(res).toThrowError(
      'you should pass text props and should be string type',
    );
  });
  ...
  it('should render normaly', async () => {
    ...
    await wait(() => {
      ...
      if (span) visibility = window.getComputedStyle(span).visibility;
